...
<?php query_posts(0); ?>
				...
				<div id="dimagiBanner" class="carousel slide dimagi-carousel">
		    		<div class="carousel-inner">
			    		<div id="banner-commcare" class="active item">
				    		<article class="async-image" data-imgsrc="img/banners/commcare.jpg">
				    			<hgroup>
				    			...
				    			<h2 class="pull-right" style="text-align: right; right:30px;  top:260px;">
				    				<a class="orange" href="http://www.commcarehq.org"><img src="img/banners/commcare-star.png" alt="CommCare" /> Learn More</a>
				    			</h2>
				    		</article>
			    		</div>
			    		<div id="banner-hire" class="item">
				    		<article class="async-image" data-imgsrc="img/banners/brazil.jpg">
				    			<hgroup>
			    		...
			    		<div id="banner-bw" class="item">
			    			<article class="async-image" data-imgsrc="img/banners/faces.jpg">
			    				<hgroup>
			    		...
			    		<div id="banner-sa" class="item">
				    		<article class="async-image" data-imgsrc="img/banners/cape_town.jpg" data-link="#">
				    			<hgroup>
			    		...
			    		<div id="banner-india" class="item">
				    		<article class="async-image" data-imgsrc="img/banners/asha.jpg" data-link="#">
				    			<hgroup>
			    ...
			    <article class="row blurbs">
			    	<section class="span3">
				    	...
				    	<div class="async-image" data-imgsrc="img/blurbs/commcare.jpg" data-imglink="http://www.commcarehq.org/"></div>
			    	...
			    	<section class="span3">
				    	...
				    	<div class="async-image" data-imgsrc="img/blurbs/open_source.jpg" data-imglink="http://www.dimagi.com/technologies/"></div>
			    	...
			    	<section class="span3">
				    	...
				    	<div class="async-image" data-imgsrc="img/blurbs/consulting.jpg" data-imglink="http://www.dimagi.com/services/"></div>		    	
				    	<p>Dimagi will to collaborate with your organization to build innovation technology solutions.</p>
			    	</section>
			    	<section class="span3">
				    	<h1>Research</h1>
				    	<div class="async-image" data-imgsrc="img/blurbs/research.jpg"></div>
				    	<p>Dimagi works domestically and across the world researching how technology can improve outcomes.</p>
			    	</section>
			    </article>
			    
			    <img src="img/divider.png" width="960" height="33" alt="divider" />
				...
				<article class="row news">
			    	<section class="span6">
			    		...
			    		<p>To my knowledge, the majority of Dimagi's work in India has been in rural areas. Indeed, the part of our mission that is focused on ... <a href="<?php the_permalink(); ?>">Read More</a></p>
			    		<?php endwhile; ?>
			    		<?php endif; ?>
			    	</section>
			    	<section class="span6">
			    		<h1><a href="/category/blog/news/">Recent News</a></h1>
			    		<?php query_posts('cat=46&showposts=4'); if (have_posts()) : ?>
